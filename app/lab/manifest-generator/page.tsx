  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 pt-28 sm:pt-36 pb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 glass-panel-elevated p-6 rounded-3xl border-white/10 space-y-4">
          ...
          <pre className="p-4 rounded-2xl bg-black/60 border border-white/5 font-mono text-xs text-zinc-200 overflow-x-auto max-h-[460px] overflow-y-auto leading-relaxed">
            {jsonString}
          </pre>
        </div>
      </div>
