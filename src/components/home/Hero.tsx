    ...
    <BackgroundPaths title="AsLynx Portfolio">
      ...
      >
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 w-full max-w-lg mb-10"
        >
          <Link
            href="/projects"
            className="flex-1 min-w-[140px] inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-cyan-400 hover:bg-cyan-300 text-black font-semibold text-sm transition-all active:scale-95"
          >
          ...
          <Link
            href="/lab"
            className="flex-1 min-w-[140px] inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl glass-panel hover-surface border border-white/10 hover:border-white/20 text-zinc-300 hover:text-white font-medium text-sm transition-all active:scale-95"
          >
