    ...
    <div className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 md:px-6 text-center">
        {children ?? (
          ...
          >
            <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold mb-6 tracking-tighter text-white dark:text-white">
            ...
            <div className="inline-block">
              <Button
                variant="default"
                className="rounded-full px-7 py-3 text-sm font-semibold bg-cyan-400 hover:bg-cyan-300 text-black transition-all active:scale-95"
              >
                Discover Excellence
